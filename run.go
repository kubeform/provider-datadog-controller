...
import (
	...
	datadogscheme "kubeform.dev/provider-datadog-api/client/clientset/versioned/scheme"
...
func init() {
	_ = datadogscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform datadog Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-datadog-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "datadog.kubeform.com",
			})
			if err != nil {
