...
var syntheticstestForceNewList = map[string]bool{}
...
func (r *Syntheticstest) ValidateUpdate(old runtime.Object) error {
	...
	for key := range syntheticstestForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`syntheticstest "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
