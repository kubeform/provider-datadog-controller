...
type UserSpecResource struct {
	...
	// +optional
	SendUserInvitation *bool `json:"sendUserInvitation,omitempty" tf:"send_user_invitation"`
	// The ID of the user invitation that was sent when creating the user.
	// +optional
	UserInvitationID *string `json:"userInvitationID,omitempty" tf:"user_invitation_id"`
