...
// +kubebuilder:rbac:groups=logs.datadog.kubeform.com,resources=metrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logs.datadog.kubeform.com,resources=metrics/status,verbs=get;update;patch
...
func (r *MetricReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logsv1alpha1.Metric{}); err != nil {
			klog.Error(err, "unable to set up auditor", logsv1alpha1.Metric{}.APIVersion, logsv1alpha1.Metric{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logsv1alpha1.Metric{}).
