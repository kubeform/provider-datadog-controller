...
// +kubebuilder:rbac:groups=webhook.datadog.kubeform.com,resources=webhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webhook.datadog.kubeform.com,resources=webhooks/status,verbs=get;update;patch
...
func (r *WebhookReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &webhookv1alpha1.Webhook{}); err != nil {
			klog.Error(err, "unable to set up auditor", webhookv1alpha1.Webhook{}.APIVersion, webhookv1alpha1.Webhook{}.Kind)
			return err
		}
	}
