...
// +kubebuilder:rbac:groups=child.datadog.kubeform.com,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=child.datadog.kubeform.com,resources=organizations/status,verbs=get;update;patch
...
func (r *OrganizationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &childv1alpha1.Organization{}); err != nil {
			klog.Error(err, "unable to set up auditor", childv1alpha1.Organization{}.APIVersion, childv1alpha1.Organization{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&childv1alpha1.Organization{}).
...
func (r *OrganizationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for Organization")
			return nil
		}
		...
		resourceList := &childv1alpha1.OrganizationList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Organization")
			return nil
		}
