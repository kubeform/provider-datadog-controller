...
// +kubebuilder:rbac:groups=dashboard.datadog.kubeform.com,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dashboard.datadog.kubeform.com,resources=dashboards/status,verbs=get;update;patch
