...
// +kubebuilder:rbac:groups=dashboard.datadog.kubeform.com,resources=jsons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dashboard.datadog.kubeform.com,resources=jsons/status,verbs=get;update;patch
