...
// +kubebuilder:rbac:groups=organization.datadog.kubeform.com,resources=settings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=organization.datadog.kubeform.com,resources=settings/status,verbs=get;update;patch
...
func (r *SettingsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &organizationv1alpha1.Settings{}); err != nil {
			klog.Error(err, "unable to set up auditor", organizationv1alpha1.Settings{}.APIVersion, organizationv1alpha1.Settings{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&organizationv1alpha1.Settings{}).
